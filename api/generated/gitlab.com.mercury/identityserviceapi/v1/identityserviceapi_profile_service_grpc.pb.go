...
func (c *profileServiceClient) GetProfile(ctx context.Context, in *GetProfileRequest, opts ...grpc.CallOption) (*GetProfileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gitlab.com.mercury.identityservice.generated.model.v1.ProfileService/GetProfile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *profileServiceClient) UpdateProfile(ctx context.Context, in *UpdateProfileRequest, opts ...grpc.CallOption) (*UpdateProfileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gitlab.com.mercury.identityservice.generated.model.v1.ProfileService/UpdateProfile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *profileServiceClient) ValidatePhone(ctx context.Context, in *ValidatePhoneRequest, opts ...grpc.CallOption) (*ValidatePhoneResponse, error) {
	out := new(ValidatePhoneResponse)
	err := c.cc.Invoke(ctx, "/gitlab.com.mercury.identityservice.generated.model.v1.ProfileService/ValidatePhone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProfileServiceServer) ValidatePhone(context.Context, *ValidatePhoneRequest) (*ValidatePhoneResponse, error) {
...
func _ProfileService_GetProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gitlab.com.mercury.identityservice.generated.model.v1.ProfileService/GetProfile",
	}
...
func _ProfileService_UpdateProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gitlab.com.mercury.identityservice.generated.model.v1.ProfileService/UpdateProfile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProfileService_ValidatePhone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidatePhoneRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProfileServiceServer).ValidatePhone(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gitlab.com.mercury.identityservice.generated.model.v1.ProfileService/ValidatePhone",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfileServiceServer).ValidatePhone(ctx, req.(*ValidatePhoneRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProfileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gitlab.com.mercury.identityservice.generated.model.v1.ProfileService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProfileService_ValidatePhone_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "identityserviceapi_profile_service.proto",
}
